locals {
  ...
  public_subnets          = [
    for subnet in var.public_subnets : {
      ...
      subnet_name           = "${var.prefix}-${subnet.project_name}-${var.environment_code}-${subnet.subnet_name}-${var.default_region}"
...
module "main" {
  ...
  #[prefix]-[project]-[env]-[resource]-[location]-[description]-[suffix]
  network_name                           = "${var.prefix}-${var.project_id}-${var.environment_code}-${var.network_name}-${var.default_region}"
